...
const es = {
  ...
  "pref.title": "Perfil de Analista & Preferencias",
  "pref.analystName": "Nombre del Analista",
  "pref.role": "Rol de Operación",
  "pref.badge": "Credencial / ID",
  "pref.theme": "Color de Acento Cyber",
  "pref.defaultTab": "Pestaña Inicial",
  "pref.defaultTlp": "Filtro TLP Inicial",
  "pref.autoRefresh": "Frecuencia de Recarga",
  "pref.save": "Aplicar Cambios",
  "pref.close": "Cerrar Panel",
  "pref.role.L1_ANALYST": "Analista SOC Nivel 1 (L1)",
  "pref.role.L2_ANALYST": "Analista SOC Nivel 2 (L2)",
  "pref.role.SEC_ADMIN": "Administrador de Ciberseguridad",
  "pref.role.GUEST": "Operador Invitado",
  "pref.role.UNASSIGNED": "No asignado",
...
const en: Record<keyof typeof es, string> = {
  ...
  "pref.title": "Analyst Profile & Preferences",
  "pref.analystName": "Analyst Name",
  "pref.role": "Operation Role",
  "pref.badge": "Credential / ID",
  "pref.theme": "Cyber Accent Color",
  "pref.defaultTab": "Initial Tab",
  "pref.defaultTlp": "Initial TLP Filter",
  "pref.autoRefresh": "Reload Frequency",
  "pref.save": "Apply Changes",
  "pref.close": "Close Panel",
  "pref.role.L1_ANALYST": "SOC Analyst Level 1 (L1)",
  "pref.role.L2_ANALYST": "SOC Analyst Level 2 (L2)",
  "pref.role.SEC_ADMIN": "Cybersecurity Administrator",
  "pref.role.GUEST": "Guest Operator",
  "pref.role.UNASSIGNED": "Unassigned",
